...
def get_user_profile(
    ...
    return UserProfileResponse(
        ...
        company_name=vendor.company_name if vendor else user.name,
        ...
        rep_name=vendor.rep_name if vendor else user.name,
        rep_designation=vendor.rep_designation if vendor else None,
        rep_phone=vendor.rep_phone if vendor else None,
        rep_email=vendor.rep_email if vendor else user.email,
        gst_number=vendor.gst_number if vendor else None,
        pan_number=vendor.pan_number if vendor else None,
        cin=vendor.cin if vendor else None,
        org_type=vendor.org_type if vendor else None,
        years_in_business=vendor.years_in_business if vendor else None,
        registered_address=vendor.registered_address if vendor else None,
        bank_account_name=vendor.bank_account_name if vendor else None,
        bank_name=vendor.bank_name if vendor else None,
        bank_account_number=vendor.bank_account_number if vendor else None,
        bank_ifsc=vendor.bank_ifsc if vendor else None,
        bank_upi=vendor.bank_upi if vendor else None,
    )
